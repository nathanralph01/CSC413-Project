...
if __name__ == '__main__':
    ...
    train(model, wrapped_data, wrapped_data_val, batch_size=2, num_epochs=6, learning_rate=0.003)
    x,t = wrapped_data[0]
    ...
    # Note: previous hidden states are used when generating sequences (during test time). Not when training
